...
class TestCornerScore(unittest.TestCase):
    """Simple dummy test for corner score to verify autograder is working."""
    ...
    def test_dummy_test(self):
        ...
        try:
            ...
            result = corners.corner_score(test_img, u=1, v=1, window_size=(2, 2))
